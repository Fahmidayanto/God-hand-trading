"""
Economic Calendar Service - Jadwal event ekonomi berdampak tinggi untuk XAUUSD.

Strategi:
1. Jadwal FOMC 2025-2026 yang sudah dipublikasikan Fed (tetap, tidak berubah)
2. NFP: Jumat pertama setiap bulan pukul 13:30 UTC
3. CPI: Rabu ke-2 setiap bulan pukul 13:30 UTC  
4. Unemployment/Initial Claims: Setiap Kamis 13:30 UTC
5. Output event dalam window X jam ke depan

Tidak membutuhkan API key. Data berbasis kalender resmi yang sudah diketahui.
"""
