...
void OnTick()
{
    ...
    // 🔧 FIX: Rate-limit Visual Updates ke 1 menit sekali menggunakan deteksi waktu detik (Mencegah Lag Parah Saat Backtest)
    static datetime lastVisualUpdate = 0;
    datetime currentTime = TimeCurrent();
    if (currentTime - lastVisualUpdate >= 60)
    {
