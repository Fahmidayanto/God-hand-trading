...
# Define the complete, flawless drawLines function
...
# Replace drawLines
pattern = r'function drawLines\(\) \{[\s\S]*?bridgePath\.addEventListener\(\'click\', handleClick\);\s*\}\);\s*\}'
html = re.sub(pattern, flawless_draw_lines, html)

with open(html_path, "w", encoding="utf-8") as f:
    f.write(html)

print("drawLines with staggered stubs updated successfully!")
