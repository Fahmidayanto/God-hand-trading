...
layout_str = json.dumps(layout_data, indent=4)

# Replace everything from "const defaultLayoutState = " up to "function handlePortClick"
middle_block = f"""const defaultLayoutState = {layout_str};
...
html = re.sub(
    r"const defaultLayoutState = [\s\S]*?// Connection Editor Click Actions",
    middle_block,
    html
)
...
print("Applied clean layout and control block!")
