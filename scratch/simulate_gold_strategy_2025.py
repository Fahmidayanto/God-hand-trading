...
# Data File Paths (Year 2025)
DATA_DIR = r"b:\Project MT5\Backtest_result"
M15_FILE = os.path.join(DATA_DIR, "MarketData_XAUUSD_M15_2025-12-30.csv")
H1_FILE = os.path.join(DATA_DIR, "MarketData_XAUUSD_H1_2025-12-30.csv")
H4_FILE = os.path.join(DATA_DIR, "MarketData_XAUUSD_H4_2025-12-30.csv")
LLHHBOS_FILE = os.path.join(DATA_DIR, "LLHHBOSData_XAUUSD_2025-12-30.csv")
SESSION_FILE = os.path.join(DATA_DIR, "SessionZone_XAUUSD_2025-12-30.csv")

OUTPUT_CSV = r"b:\Project MT5\scratch\Backtest_Results_XAUUSD_2025_Simulated.csv"

# ==========================================
# DATA LOADING
# ==========================================
print("[INFO] Loading 2025 Market Data...")
...
for idx, row in bos_df.iterrows():
    # Handle time format with possible dots or dashes
...
# ==========================================
print("[INFO] Running M15 Strategy Backtest Simulation for 2025...")
