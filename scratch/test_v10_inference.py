...
logger.info(f"✅ Live Joint Inference Result: Signal={res['signal']}, Predicted_MFE={res.get('predicted_mfe', 0):.2f}, Predicted_MAE={res.get('predicted_mae', 0):.2f}, Expected_RR={res.get('expected_rr', 0):.2f}, Confidence={res.get('confidence', 0):.2f}")
